...
////            }
//        }
        List<Lend> result = lendService.select(null);
    ...
    private void returnBook(){
        ...
        List<Lend> list = lendService.returnBook(lend);
        //展示最新结果
        lends = new ObservableListWrapper<Lend>(new ArrayList<Lend>(list));
//        //刷新页面
